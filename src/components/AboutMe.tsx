...
export default function AboutMe() {
  ...
  return (
    ...
    >
      ...
      >
        <a 
          href="https://github.com/sirikarra" 
          target="_blank" 
          rel="noopener noreferrer"
          className="inline-flex items-center px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-full transition-colors duration-300 font-['Playfair_Display']"
        >
